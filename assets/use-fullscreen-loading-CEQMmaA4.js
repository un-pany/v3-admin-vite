import"./index-BJuo73Ud.js";/* empty css                *//* empty css                  *//* empty css                 *//* empty css                   */import{ai as m,a3 as g,o as f,r as E,E as l}from"./element-CiAb6Vel.js";import{t as y,v as w,M as n,E as c,J as p,x}from"./vue-Cdw772MT.js";import{_ as C}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./vxe-DOrOiySX.js";const S={lock:!0,text:"加载中..."},u=(t,e={})=>{let s;return async(...a)=>{try{return s=m.service({...S,...e}),await t(...a)}finally{s.close()}}},v={code:0,data:{list:[]},message:"获取成功"};function A(t){return new Promise(e=>{setTimeout(()=>{e({...v,data:{list:t}})},1e3)})}function k(){return new Promise((t,e)=>{setTimeout(()=>{e(new Error("发生错误"))},1e3)})}const b={class:"app-container"},h=`
  <path class="path" d="
    M 30 15
    L 28 17
    M 25.61 25.61
