import"./index-MnmukvK0.js";/* empty css                  *//* empty css                *//* empty css                   */import{ah as m,o as _,E as u,t as g}from"./element-zW3XFg-9.js";import{t as f,v as E,x as y,L as a,J as n,a2 as c}from"./vue-V9u7w0-f.js";import{_ as w}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./vxe-_W0GpTmX.js";const x={lock:!0,text:"加载中..."},p=(o,e={})=>{let r;return async(...i)=>{try{return r=m.service({...x,...e}),await o(...i)}finally{r.close()}}},v={code:0,data:{list:[]},message:"获取成功"};function C(o){return new Promise(e=>{setTimeout(()=>{e({...v,data:{list:o}})},1e3)})}function S(){return new Promise((o,e)=>{setTimeout(()=>{e(new Error("发生错误"))},1e3)})}const k={class:"app-container"},A=`
  <path class="path" d="
    M 30 15
    L 28 17
    M 25.61 25.61
